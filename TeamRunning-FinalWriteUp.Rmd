...
```
Here we plot the experimental probability of a team making it onto the podium (top 4). This is the minimum placing which receives a big trophy. You can see that Williams and North Central have the highest probability of making the podium, which matches the USTFCCCA coaches poll going into the national meet. That poll ranked Williams 1st and North Central 2nd.
...
```
Below we plot the ranking of each team in the simulation minus the true outcome at the national meet, giving us the "rankings jump" of each team.
...
```{r Map, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
library(maps)
...
dfPoints=data.frame(lat=c(41.772769, 38.648823, 43.817551, 40.009308, 42.728922, 42.370855, 34.101537, 42.712813, 39.329901, 42.796139, 41.788720, 42.729700, 44.461325, 44.008000, 42.360162, 40.442748, 42.929477, 41.504277, 44.871635, 44.461663, 37.572379, 44.105683, 34.101217, 40.125502, 42.471333, 44.943629, 33.797065, 44.026202, 38.212276), 
                    ...
                    places=paste(c(intersect(c$TEAM, d$TEAM), "Oshkosh", "Louisville")))
map("usa")
