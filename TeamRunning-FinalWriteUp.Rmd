...
full_teams_plus_results<- full_teams_plus_results %>% mutate(Norm_Prob_Rank = ifelse(pnorm(PL, mean=Expected_Place, sd=SD_Simulated_Place)>0.5, 1-pnorm(PL, mean=Expected_Place, sd=SD_Simulated_Place), pnorm(PL, mean=Expected_Place, sd=SD_Simulated_Place)))
```
